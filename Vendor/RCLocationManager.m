...
static NSString *const RCLocationManagerLoggingEnvironmentKey = @"DEBUG_LOG";
...
- (id)init
{
		if (NSProcessInfo.processInfo.environment[RCLocationManagerLoggingEnvironmentKey] != nil) {
