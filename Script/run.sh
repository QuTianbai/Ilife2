...
echo "========================================================================="
echo "ios-sim launch build/${MAIN_TARGET}.app --devicetypeid 'com.apple.CoreSimulator.SimDeviceType.iPhone-6, 8.4' --exit"
echo "========================================================================="

# ios-sim launch build/Example.app --devicetypeid 'com.apple.CoreSimulator.SimDeviceType.iPhone-6, 8.4'
ios-sim launch $BUILD_DIR/${MAIN_TARGET}.app --devicetypeid 'com.apple.CoreSimulator.SimDeviceType.iPhone-6, 8.4' --exit
