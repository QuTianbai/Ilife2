...
@interface MSFTableViewBindingHelper () <UITableViewDataSource, UITableViewDelegate>

@end

@implementation MSFTableViewBindingHelper {
...
+ (instancetype)bindingHelperForTableView:(UITableView *)tableView
  ...
  return [[MSFTableViewBindingHelper alloc] initWithTableView:tableView
                                                sourceSignal:source
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
  id<MSFReactiveView> cell = [tableView dequeueReusableCellWithIdentifier:_templateCell.reuseIdentifier];
