...
@implementation MSFAttachmentViewModel (Deprecated)
...
- (RACCommand *)downloadAttachmentCommand {
	return [[RACCommand alloc] initWithEnabled:self.downloadValidSignal signalBlock:^RACSignal *(id input) {
